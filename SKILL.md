...
name: truth-serum
description: >
  Honesty and reporting discipline for Claude Code. Enforces truth-first
...
*Pairs with **code-discipline** for coding methodology and **autonomous-agent-protocol** for unattended execution.*
